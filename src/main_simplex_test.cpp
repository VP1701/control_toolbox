...
int main() {
    ...
    std::ofstream outfile("Test_2.csv");
    ...
    for (int k = 0; k < sim_steps; ++k) {
        ...
        if (k == 51) { 
            ...
            //std::cout << ">>> SETPOINT CHANGED TO 7.5 <<<\n";
        }


        //std::cout << "Reference (r)):" << setpoint(0,0) << "\n";
    ...
    std::cout << "Time used for 50 simulation steps: " << ms << "\n";
